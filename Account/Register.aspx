...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <hgroup class="title">
        <h2>Sử dụng mẫu bên dưới để đăng ký tài khoản</h2>
    </hgroup>
            ...
            <asp:CreateUserWizardStep runat="server" ID="RegisterUserWizardStep">
                <ContentTemplate>
                    <p class="message-info">
                        Mật khẩu phải có ít nhất <%: Membership.MinRequiredPasswordLength %> một ký tự.
                    </p>
                    ...
                    <fieldset>
                        ...
                        <ol>
                            ...
                            <li>
                                <asp:Label runat="server" AssociatedControlID="ConfirmPassword">Chấp nhận mật khẩu</asp:Label>
